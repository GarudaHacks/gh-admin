...
export interface FirestoreUser {
  ...
  // Dispensation (leave) letter — generated by scripts/generate-leave-letters.mjs,
  // emailed from the Mailing page. leaveLetterSentAt is stamped on each email send.
