interface DispensationLetter {
  // Direct link to the participant's generated dispensation (leave) letter PDF.
  actionUrl: string;
}

export function dispensationLetter({ actionUrl }: DispensationLetter): string {
  return `<!DOCTYPE html>
<html>
<head>
...
<body style="font-family: 'Poppins', Helvetica, sans-serif; background:#f4f4f4; padding:20px;">
  <table width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr>
      <td style="padding:24px;color:#333; text-align: left;">
        <h1>Dispensation Letter</h1>
        <p>Hello hacker,</p>
        <p>Please download the dispensation letter you requested below.</p>
        ...
        <div style="color: #909090; font-size: 10px; text-align: center;">
